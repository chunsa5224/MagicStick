...
public class bluetooth_talk extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bluetooth_talk);
        ...
        // 리스트 뷰 어댑터 생성
        list = new ArrayList<>();
        arrayAdapter = new ArrayAdapter(bluetooth_talk.this, android.R.layout.simple_list_item_1, list);
        // 항상 최하단 아이템으로 유지
        ...
        button_pairing.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                finish();
                startActivity(new Intent(bluetooth_talk.this, bluetooth_connect.class));
            }
        });
        ...
        // 동적 버튼 객체 생성
        final Button newbtn = new Button(bluetooth_talk.this);
        ...
        thread = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                while(!Thread.currentThread().isInterrupted()) {
                    ...
                    // 문자열 개수를 받아옴
                    try {
                        byteAvailabe = bluetooth_connect.inputStream.available();
                    }
                    catch (IOException e) {
                        e.printStackTrace();
                    }
                    ...
                    if(byteAvailabe > 0) {
                        ...
                        // 바이트 배열 크기만큼 읽어옴
                        try {
                            bluetooth_connect.inputStream.read(packetByte);
                        }
                        catch (IOException e) {
                            e.printStackTrace();
                        }
                        ...
                        for(int i = 0; i < byteAvailabe; i++) {
                            ...
                            if(readData != '\n') {
                                ...
                                final PendingIntent pendingIntent = PendingIntent.getActivity(bluetooth_talk.this, 0,
                                        new Intent(getApplicationContext(), bluetooth_talk.class), PendingIntent.FLAG_UPDATE_CURRENT);
                                ...
                                handler.post(new Runnable() {
                                    ...
                                    public void run() {
                                        ...
                                        // 1 입력 받을 때
                                            ...
                                            // 알림 객체 설정
                                            builder = new Notification.Builder(bluetooth_talk.this)
